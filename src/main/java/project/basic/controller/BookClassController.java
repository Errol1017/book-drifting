...
public class BookClassController {
    ...
    public Object getAgencyList(HttpServletRequest request) throws Exception {
    ...
    public Object getAgencyForm(HttpServletRequest request) throws Exception {
    ...
    public Object submitAgency(HttpServletRequest request) throws Exception {
    ...
    public Object deleteAgency(HttpServletRequest request) throws Exception {
        String dataId = request.getParameter("dataId");
        Book book = comService.getFirst(Book.class, "classificationId="+dataId);
        if (book!=null){
            return Result.ERROR(ErrorCode.CUSTOMIZED_ERROR, "该分类下还有相关图书，无法删除");
        }
        BookClassification bc = comService.getDetail(BookClassification.class, Integer.parseInt(dataId));
